/***********************************************************
*
* $Header: /home/cvs/smsc/skt-smsc/include/ksig7/mtpOamDefs.h,v 1.1 2008/07/21 05:12:47 prowoni Exp $
*
* $Source: /home/cvs/smsc/skt-smsc/include/ksig7/mtpOamDefs.h,v $
* $Revision: 1.1 $
* $Locker:  $
* 
***********************************************************/
...
/* Mtp Oam objects	  */
/**************************************************************************
| Modified 2.3.93 JMR to add the statuses and commands for 
| the link inhibit
***************************************************************************/
...
#ifndef UNUSED_ALIAS_SLOT
#define UNUSED_ALIAS_SLOT  -1
#endif
...
|   ObjAddr [1] is the linkset or destination or local alias address
 ...
 typedef enum
	{
			 ...
			 mtp_timer1     = 2,         /* Timer 1-17 as defined in CCITT Q704 */
			 mtp_timer2     = 3,
			 mtp_timer3     = 4,
			 mtp_timer4     = 5,
			 mtp_timer5     = 6,
