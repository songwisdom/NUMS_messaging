...
|                               -------------
|
| Type definitions for the Sccp Oam interface
|
| $Source: /home/cvs/smsc/skt-smsc/include/ksig7/sccpOamDefs.h,v $
| $Revision: 1.1 $
...
#define NB_SO_CMD 15  /* To be modified if the above enum is modified */
