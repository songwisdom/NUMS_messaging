...
|
| $Source: /home/cvs/smsc/skt-smsc/include/ksig7/ss7errors.h,v $ 
| $Revision: 1.1 $ 
...
typedef enum {
  ...
  EAPIINTERNALMTP      ,     /* (=15) Internal library error */
  EAPIINTERNALSCCP     ,
  EAPIINTERNALOAM      ,     /* Internal library error */
  ...
  EAPIALRDYINUSE       ,     /* SSN or SI already in use */
