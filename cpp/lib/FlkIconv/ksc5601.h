...
#ifndef _H_FLK_KSC5601_
#define _H_FLK_KSC5601_
typedef struct {
...
static int
flk_ksc5601_mbtowc (flk_conv_t conv, flk_ucs4_t *pwc, const unsigned char *s, int n)
{
...
static int
flk_ksc5601_wctomb (flk_conv_t conv, unsigned char *r, flk_ucs4_t wc, int n)
{
  if (n >= 2) {
